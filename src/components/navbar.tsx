        ...
        <motion.div className="flex items-center space-x-2" layout>
          ...
          {navItems.map((item) => (
            <motion.div
              key={item.id}
              layout
              whileHover={{ marginLeft: 8, marginRight: 8, scale: 1.02 }}
              whileTap={{ scale: 0.96 }}
            ...
            >
              <Button
                variant="ghost"
                size="sm"
                className="rounded-full h-9 w-9 p-0 hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-300 text-gray-600 dark:text-gray-400 hover:text-black dark:hover:text-white group relative"
                title={item.label}
              >
          ...
          {/* Theme Toggle */}
          <motion.div layout whileHover={{ marginLeft: 8, marginRight: 8, scale: 1.02 }} whileTap={{ scale: 0.96 }} transition={{ type: "spring", stiffness: 400, damping: 30 }}>
            <Button
              variant="ghost"
              size="sm"
              className="rounded-full h-9 w-9 p-0 hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-300 text-gray-600 dark:text-gray-400 hover:text-black dark:hover:text-white group relative"
